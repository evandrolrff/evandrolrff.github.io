...
<template>
  <section id="experience" class="section">
    <div class="container">
      <p class="eyebrow reveal">My Journey</p>
      <h2 class="section-heading reveal d1">Experience & Formation</h2>

      <!-- Tabs -->
      <div class="tabs reveal d2">
        <button
          :class="['tab-btn', { active: tab === 'experience' }]"
          @click="tab = 'experience'"
        >Experience</button>
        <button
          :class="['tab-btn', { active: tab === 'education' }]"
          @click="tab = 'education'"
        >Education</button>
      </div>
